...
export default {
	...
	GMAIL_ADRESS: process.env.GMAIL_ADRESS || 'your_GMAIL_ADRESS',
	GMAIL_PASSWORD: process.env.GMAIL_PASSWORD || 'your_GMAIL_PASSWORD',
	GMAIL_OWNER_NAME: process.env.GMAIL_NAME || 'your_GMAIL_NAME',
